...
const PRODUCTS = [
  {
    id:"p1", sku:"Z.162305.1684217109668634",
    name:"فلتر نقاء ٧ مراحل + توصيل وتركيب مجاناً",
    cat:"فلاتر تحلية", price:594, oldPrice:800,
    url:"https://pu.sa/products/7steg",
    image:"https://cdn.salla.sa/OQRbq/aJmYgFqeXGk9S0p1DxJNNYYFhpZbHmvXgPMb4CU2.png",
    desc:"فلتر نقاء ٧ مراحل بتقنية التناضح العكسي RO. يمتلك قدرة إنتاج تصل إلى 300 لتر من المياه المحلاة يومياً (ما يعادل 16 جركل كبيرة). مضخة قوية 130 PSI لتسريع عملية التحلية. يشمل مرحلة سابعة لموازنة قيمة القلوية PH. توصيل وتركيب مجاناً. ضمان سنتين. صنع في الصين بمواصفات نقاء الخاصة.",
    features:"المرحلة 1: فلتر شوائب 5 ميكرون | المرحلة 2: فلتر كربون نشط | المرحلة 3: فلتر كربون صلب | المرحلة 4: غشاء التناضح العكسي RO | المرحلة 5: Post Carbon | المرحلة 6: محسن القلوية PH | المرحلة 7: فلتر متعدد المعادن | مضخة 130 PSI | خزان فايبر 7 لتر | حنفية كرومية 1/4 انش | هوز 5 متر | محبس دخول ماء | قاعدة تثبيت أرضية | ضمان سنتين",
    minStock:10
  },
  {
    id:"p2", sku:"Z.162305.16398648037738101",
    name:"فلتر جامبو لتنقية الخزان",
    cat:"فلاتر تحلية", price:1900, oldPrice:null,
    url:"https://pu.sa/products/فلتر-جامبو-لتنقية-الخزان",
    image:"https://cdn.salla.sa/OQRbq/xTR5mJkTkfnJvQwGUyZI0u6vYkYTz8HgqWcEBCH0.png",
    desc:"فلتر جامبو لتنقية مياه الخزانات بشكل فعّال. يحتوي على 3 مراحل تنقية تقضي على الشوائب والأوساخ والصدأ والكلور. يُركَّب قبل الخزان العلوي في البيت. مصنوع من مواد عالية الجودة مقاومة للصدأ. رأس PET عالي الجودة مع صمام تنفيس للهواء. يتحمل درجات حرارة 5-55 مئوية وضغط حتى 10 بار. يُستبدل كل 4-6 أشهر.",
    features:"المرحلة 1: شمعة قطنية لإزالة الصدأ والشوائب والأتربة | المرحلة 2: فلتر كربون نشط لإزالة الكلور وتحسين الطعم | المرحلة 3: فلتر كربون صلب لتأكيد نقاء المياه | رأس PET عالي الجودة | صمام تنفيس الهواء | فتحات دخول/خروج 1 بوصة | يتحمل ضغط 10 بار | بدون تحلية (للاستخدام المنزلي العام)",
    minStock:5
  },
  {
    id:"p3", sku:"Z.162305.16852922028164399",
    name:"برادة فاخرة من نقاء + توصيل وتركيب مجاناً",
    cat:"برادات مياه", price:550, oldPrice:600,
    url:"https://pu.sa/products/Water-cooler-3-colors",
    image:"https://cdn.salla.sa/OQRbq/8rz7cKpv0s7TQK2lgQxaZB9KXRI5CcYSzXOjJy7b.png",
    desc:"برادة مياه فاخرة من نقاء بخزان داخلي وتعبئة ذاتية. تُوصَّل مباشرة بجهاز التحلية. 3 صنابير (بارد، فاتر، حار). زر أمان للماء الساخن لحماية الأطفال. متوفرة بـ 3 ألوان (أبيض، أسود، فضي). تدفق ماء سريع لملء الأكواب. حجم صغير مناسب للطاولات. توصيل وتركيب مجاناً. ضمان سنتين.",
    features:"3 صنابير (بارد/فاتر/حار) | زر أمان للماء الساخن | خزان داخلي بتعبئة ذاتية | توصيل مباشر بجهاز التحلية | عوامة للتحكم في التعبئة | 3 ألوان (أبيض/أسود/فضي) | تصميم طاولة عملي | تدفق ماء سريع | ضمان سنتين | صنع بمواصفات سعودية",
    minStock:8
  },
  {
    id:"p4", sku:"Z.162305.1684217109668634-PKG",
    name:"بكج التوفير (فلتر مياه ٧ مراحل + برادة مياه) + توصيل وتركيب مجاناً",
    cat:"بكجات", price:2500, oldPrice:null,
    url:"https://pu.sa/products/filtr999",
    image:"https://cdn.salla.sa/OQRbq/Ow9ycKpmU5AK3LVcXGfr72YcH9lVKlk1pvFAoEtj.png",
    desc:"عرض التوفير الرائع: فلتر مياه متقدم 7 مراحل + برادة مياه فاخرة من نقاء بـ 3 ألوان (أبيض، أسود، فضي). الفلتر بتقنية RO ينتج 300 لتر يومياً. البرادة بخزان 7 لتر فايبر جلاس وحنفية كروم 1/4 انش. 3 صنابير بارد/فاتر/حار. التوصيل والتركيب مجاناً. ضمان سنتين لكلا الجهازين.",
    features:"فلتر 7 مراحل كامل بتقنية RO | برادة فاخرة 3 ألوان | خزان فايبر 7 لتر | حنفية كروم 1/4 انش | 3 صنابير (بارد/فاتر/حار) | زر أمان للحار | توصيل وتركيب مجاني | إنتاج 300 لتر/يوم | ضمان سنتين",
    minStock:5
  },
  {
    id:"p5", sku:"Z.162305.1663523045645338",
    name:"صيانة كاملة 6 مراحل + توصيل وتركيب مجاناً",
    cat:"صيانة دورية", price:595, oldPrice:null,
    url:"https://pu.sa/products/صيانة-كاملة-6-مراحل",
    image:"https://cdn.salla.sa/OQRbq/xTR5mJkTkfnJvQwGUyZI0u6vYkYTz8HgqWcEBCH0.png",
    desc:"طقم صيانة سنوي لجهاز تحلية المياه بتقنية 6 مراحل. يدوم لأكثر من سنة واحدة. يضمن استمرارية أداء الجهاز بكفاءة عالية. يزيل الشوائب والأتربة والمواد الكيميائية ويضيف المعادن الضرورية. توصيل وتركيب مجاناً.",
    features:"المرحلة 1: فلتر قطن 5 ميكرون | المرحلة 2: كربون نشط (طعم وكلور) | المرحلة 3: كربون صلب (مضاد فطريات) | المرحلة 4: بوست RO (1/1000 ميكرون - 300 لتر/يوم) | المرحلة 5: بوست كربون نشط | المرحلة 6: فلتر معادن | توصيل وتركيب مجاناً | يدوم سنة كاملة",
    minStock:20
  },
  {
    id:"p6", sku:"Z.162305.filters-spare-set",
    name:"طقم فلاتر قطع غيار (مرحلة 1-2-3)",
    cat:"قطع غيار", price:95, oldPrice:null,
    url:"https://pu.sa/products/",
    image:"https://cdn.salla.sa/OQRbq/aJmYgFqeXGk9S0p1DxJNNYYFhpZbHmvXgPMb4CU2.png",
    desc:"طقم قطع غيار يشمل المراحل الأولى والثانية والثالثة لفلتر التحلية: فلتر شوائب 5 ميكرون + فلتر كربون نشط + فلتر كربون صلب. مناسب لجميع أجهزة نقاء. يُستبدل كل 6 أشهر.",
    features:"فلتر شوائب بولي بروبيلين 5 ميكرون | فلتر كربون نشط (يزيل الكلور والطعم) | فلتر كربون صلب (تنقية إضافية) | مناسب لأجهزة نقاء 7 مراحل | يُستبدل كل 6 أشهر | سهل التركيب",
    minStock:50
  },
  {
    id:"p7", sku:"Z.162305.membrane-ro",
    name:"ممبرين RO (غشاء التناضح العكسي)",
    cat:"قطع غيار", price:150, oldPrice:null,
    url:"https://pu.sa/products/",
    image:"https://cdn.salla.sa/OQRbq/aJmYgFqeXGk9S0p1DxJNNYYFhpZbHmvXgPMb4CU2.png",
    desc:"غشاء التناضح العكسي - المرحلة الرابعة والأهم في فلتر التحلية. يزيل الأملاح والفيروسات والبكتيريا. طاقة إنتاجية 300 لتر/يوم. مسامات 1/1000 ميكرون. يُستبدل كل سنة إلى سنة ونصف.",
    features:"مسامات 1/1000 ميكرون | إنتاج 300 لتر/يوم | يزيل الأملاح والفيروسات والبكتيريا | مطابق لمواصفات نقاء | يُستبدل كل 12-18 شهراً",
    minStock:20
  },
  {
    id:"p8", sku:"Z.162305.post-carbon",
    name:"فلتر Post Carbon + محسن القلوية + المعادن",
    cat:"قطع غيار", price:130, oldPrice:null,
    url:"https://pu.sa/products/",
    image:"https://cdn.salla.sa/OQRbq/aJmYgFqeXGk9S0p1DxJNNYYFhpZbHmvXgPMb4CU2.png",
    desc:"طقم المراحل الأخيرة (5-6-7): Post Carbon لإزالة الكلور الزائد + محسن القلوية PH + فلتر متعدد المعادن لإضافة المعادن الضرورية وتحسين طعم المياه. يُستبدل مع طقم الصيانة السنوية.",
    features:"Post Carbon (إزالة كلور زائد) | محسن القلوية PH | فلتر متعدد المعادن | يحسن طعم ورائحة المياه | يضيف معادن ضرورية للجسم | يُستبدل كل 12 شهراً",
    minStock:30
  },
  {
    id:"p9", sku:"Z.162305.tank-7ltr",
    name:"خزان فايبر جلاس 7 لتر",
    cat:"ملحقات", price:120, oldPrice:null,
    url:"https://pu.sa/products/",
    image:"https://cdn.salla.sa/OQRbq/Ow9ycKpmU5AK3LVcXGfr72YcH9lVKlk1pvFAoEtj.png",
    desc:"خزان تخزين المياه المحلاة سعة 7 لتر. مصنوع من الفايبر جلاس المقاوم للصدأ. يأتي مع جهاز فلتر نقاء 7 مراحل. قابل للاستبدال المنفرد.",
    features:"سعة 7 لتر | فايبر جلاس مقاوم للصدأ | مناسب لجميع أجهزة RO | خفيف الوزن | مضمون لسنتين",
    minStock:10
  },
  {
    id:"p10", sku:"Z.162305.faucet-chrome",
    name:"حنفية كرومية + هوز توصيل",
    cat:"ملحقات", price:65, oldPrice:null,
    url:"https://pu.sa/products/",
    image:"https://cdn.salla.sa/OQRbq/8rz7cKpv0s7TQK2lgQxaZB9KXRI5CcYSzXOjJy7b.png",
    desc:"حنفية كرومية أنيقة مقاس 1/4 انش لتوزيع المياه المحلاة + هوز توصيل 5 متر. مناسبة لجميع أجهزة فلاتر نقاء. تصميم أنيق يناسب جميع بيئات المطبخ.",
    features:"حنفية كروم 1/4 انش | هوز 5 متر | محبس دخول ماء 1/4 انش | توصيلات مواسير كرومية 1/2 و 3/4 انش | سهلة التركيب والاستبدال | مقاومة للصدأ",
    minStock:15
  },
];
